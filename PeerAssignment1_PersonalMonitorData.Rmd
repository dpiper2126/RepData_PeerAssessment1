...
```{r}
sum(is.na(personal_data_fill$steps))
```


#### Make a histogram of the total number of steps taken each day and calculate and report the mean and median total number of steps taken per day
```{r}
clean_data_steps_per_day <- aggregate(steps ~ date, personal_data_fill, sum)
...
data_weekdays <- data_by_weekdays(personal_data_fill)
```
